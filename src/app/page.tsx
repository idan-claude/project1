...
const FEATURE_SLIDES = [
  ...
  },
  {
    ...
    desc: '1.8מ"מ ו-7 גרם. לא תרגיש אותו בארנק, לא בתיק, לא בכיס. הוא פשוט שם — ואתה רק פותח את הטלפון כשצריך למצוא.',
  ...
  },
  {
    ...
    desc: 'הכרטיס מוגן IP67 — שוקע מטר עומק ל-30 דקות ולא קורה לו כלום. נפל לשירותים? נכנס לכביסה בטעות? יצא ממנה עובד. גשם, שלג — לא מוסיף לחץ.',
...
const REVIEWS = [
  ...
  },
  {
    ...
    text: 'קניתי שלושה — לי לאשתי ולבן ה14 שמאבד כל דבר. הבן שלי "איבד" את תיק הספרים בבית ספר ומצאנו אותו תוך דקה 😂 עשה לי שיחות טלפון של בכי שמחה',
  },
  {
    initials: 'ש', color: 'bg-purple-500', name: 'שירה ל.', location: 'ירושלים',
    stars: 5, detail: 'לקוחה 5 חודשים',
    text: 'טסתי לאמסטרדם ואיבדתי המזוודה בפרנקפורט. ידעתי בדיוק שהיא בשדה התעופה הגרמני!! הראיתי לשרות לקוחות את המפה ושלחו אותה אלי. הציל לי את החופשה ממש',
  },
  {
  ...
  },
  {
    ...
    text: 'קניתי לאמא שלי בת ה78 שמאבדת הארנק כל יום. פשוט מתקשרים אליה ואנחנו מוצאים דרך הטלפון שלנו. שלום נפשי לכל המשפחה ממש!!!',
  },
  {
  ...
  },
  {
    ...
    text: 'עובד אבל לא הבנתי בדיוק איך להגדיר אותו לבד. יצרתי קשר עם שרות לקוחות ועזרו לי מהר. עכשיו עובד מעולה. אולי תעשו וידאו הגדרה?',
  },
  {
