...
const FAQS = [
  ...
  { q: 'האם זה עובד עם אנדרואיד?', a: 'כרגע FindCard תואם Apple Find My בלבד — iPhone ו-iPad עם iOS 14.5 ומעלה. אנחנו עובדים על גרסת Android עם תאימות ל-Google Find My Device, שתצא בקרוב. הירשמו לניוזלטר שלנו כדי לדעת ראשונים!' },
