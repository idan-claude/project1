...
const INTEGRATIONS: IntegrationDef[] = [
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'capiToken', label: 'קוד גישה לשרת', placeholder: '••••••••', type: 'password', sensitive: true, hint: 'הגדרות עסקיות ב-Meta → משתמשי מערכת → צור קוד גישה' },
  ...
  },
  {
    ...
    fields: [
      ...
      { key: 'eventsApiToken', label: 'קוד גישה לשרת', placeholder: '••••••••', type: 'password', sensitive: true, hint: 'TikTok Ads Manager → פרסומות → ניהול אירועים → קוד גישה' },
    ],
  },
  {
    id: 'smtp',
  ...
  },
  {
    ...
    fields: [
      { key: 'cloudName', label: 'שם החשבון', placeholder: 'my-store', type: 'text', hint: 'פרטי החשבון בלוח הבקרה של Cloudinary' },
      { key: 'apiKey', label: 'מפתח גישה', placeholder: '123456789012345', type: 'text', hint: 'הגדרות → אבטחה בלוח הבקרה של Cloudinary' },
