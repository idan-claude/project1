...
const REVIEWS = [
  { photo: 'https://i.pravatar.cc/80?img=9', name: 'דנה כ.', location: 'תל אביב', stars: 5, detail: 'לקוחה 4 חודשים', text: 'שנתיים ממש הייתי מאבדת ארנק כל שבוע, פעמיים שלוש פעמים. מאז שהכנסתי את FindCard? לא חיפשתי פעם אחת. ממש ממליצה 🙏' },
  { photo: 'https://i.pravatar.cc/80?img=33', name: 'אבי מ.', location: 'חיפה', stars: 5, detail: 'קנה 3 יחידות · לקוח 6 חודשים', text: 'קניתי 3 — לי, לאשה ולבן שמאבד הכל. הבן "איבד" ילקוט בבית ספר ומצאנו אותו תוך דקה!! ממליץ בחום לכל המשפחה.' },
  { photo: 'https://i.pravatar.cc/80?img=26', name: 'שירה ל.', location: 'ירושלים', stars: 5, detail: 'לקוחה 5 חודשים', text: 'טסתי לאמסטרדם ואיבדתי מזוודה בפרנקפורט. ידעתי בדיוק שהיא שם! הראיתי לשירות לקוחות את המפה ושלחו אליי. הציל לי את החופשה ממש.' },
  { photo: 'https://i.pravatar.cc/80?img=44', name: 'מרים ה.', location: 'נתניה', stars: 5, detail: 'קנתה לאמא · לקוחה 5 חודשים', text: 'קניתי לאמא שלי בת ה-78 שמאבדת ארנק כל יום. פשוט מתקשרים אליה ומוצאים דרך הטלפון שלנו. שלום נפשי לכל המשפחה!' },
  { photo: 'https://i.pravatar.cc/80?img=63', name: 'נועה ג.', location: 'הרצליה', stars: 4, detail: 'לקוחה 3 חודשים', text: 'קיבלתי במתנה ולא ידעתי אם אשתמש. חודש אחרי — ארנק נפל מהתיק בקניון, Find My הראה שהוא עדיין שם. חזרתי ומצאתי. חסכתי כ-750 שקל.' },
  { photo: 'https://i.pravatar.cc/80?img=17', name: 'תומר ז.', location: 'גבעתיים', stars: 3, detail: 'לקוח חודשיים', text: 'עובד כמו שאמרו. ההגדרה הייתה קצת מבלבלת בהתחלה אבל אחרי 5 דקות הסתדרתי. המשלוח לקח כשבועיים. בסך הכל מרוצה' },
  { photo: 'https://i.pravatar.cc/80?img=5', name: 'יוסי ב.', location: 'ראשון לציון', stars: 5, detail: 'קנה 2 יחידות · לקוח 7 חודשים', text: 'בחיים מאבד מפתחות, רציני. אחרי FindCard לוחץ וביפ! מצא. חסך לי כבר 3 כפילות (כל אחד 150 שח אז תחשבו...) שווה כל אגורה' },
  { photo: 'https://i.pravatar.cc/80?img=12', name: 'רחל ס.', location: 'באר שבע', stars: 5, detail: 'לקוחה 8 חודשים', text: 'הכרטיס ממש דק ולא מורגש כלל בארנק. שכחתי שהוא שם עד שארנק נפל בסופר ומצאתי אותו תוך 30 שניות. מעולה.' },
  { photo: 'https://i.pravatar.cc/80?img=21', name: 'גל ד.', location: 'פתח תקווה', stars: 5, detail: 'לקוחה 3 חודשים', text: 'קניתי לבעל שלי שמאבד הכל תמיד. השינוי דרמטי. הוא אפילו לא מאמין שמצא את הארנק לבד :-) תודה רבה!' },
  { photo: 'https://i.pravatar.cc/80?img=52', name: 'עמית כ.', location: 'כפר סבא', stars: 4, detail: 'לקוח 5 חודשים', text: 'מוצר טוב מאוד. הייתי סקפטי בהתחלה אבל זה באמת עובד. פעם אחת הצג הראה שהארנק "50 מטר" ומצאתי אותו בין כריות הספה 😅' },
  { photo: 'https://i.pravatar.cc/80?img=38', name: 'ליאת מ.', location: 'רמת גן', stars: 5, detail: 'קנתה לבן זוג · לקוחה 6 חודשים', text: 'קניתי לבן זוג ליום הולדת — הוא היה מרוגז ש"קיבל מתנה פרקטית" אבל אחרי שבוע שלח לי תודה עם 3 לבבות כי מצא ארנק שאיבד 😄' },
  { photo: 'https://i.pravatar.cc/80?img=57', name: 'ניר ש.', location: 'אשדוד', stars: 5, detail: 'לקוח 4 חודשים', text: 'אני נהג מסירות ומאבד מפתחות רכב כמה פעמים בחודש. מאז FindCard לא היו לי עיכובים בגלל מפתחות. ממליץ לכל מי שעובד בשטח' },
  { photo: 'https://i.pravatar.cc/80?img=41', name: 'חנה א.', location: 'חולון', stars: 5, detail: 'קנתה לאבא · לקוחה 9 חודשים', text: 'קניתי לאבא בן ה-82. כל שבוע היינו מחפשים לו ארנק בכל הבית. עכשיו הוא לוחץ על הכפתור והכרטיס מצפצף. הוא כל כך מאושר.' },
  { photo: 'https://i.pravatar.cc/80?img=48', name: 'בן ל.', location: 'מודיעין', stars: 4, detail: 'לקוח חודשיים', text: 'עובד מעולה. הגעתי דרך חבר שהמליץ ולא מצטער. אולי קצת יקר אבל שווה כל שקל אם אתה מאבד דברים' },
  { photo: 'https://i.pravatar.cc/80?img=30', name: 'יעל פ.', location: 'גבעת שמואל', stars: 5, detail: 'לקוחה 5 חודשים', text: 'AirTag היה גדול מדי לארנק שלי. FindCard נכנס כמו כרטיס אשראי רגיל. 5 חודשים ולא הפסדתי ארנק אחד. זהו. תגמרו לחשוב ותקנו.' },
  { photo: 'https://i.pravatar.cc/80?img=13', name: 'ערן ט.', location: 'נס ציונה', stars: 5, detail: 'לקוח שנה', text: 'שנה שלמה ועדיין עובד מצוין. הסוללה עדיין מחזיקה חזק. המוצר הכי שווה שקניתי השנה בלי ספק. 10/10' },
  { photo: 'https://i.pravatar.cc/80?img=68', name: 'טל ר.', location: 'אילת', stars: 5, detail: 'לקוח 6 חודשים', text: 'גרתי באילת ואיבדתי ארנק בים. חששתי שהמים יהרסו אותו אבל IP67 — הכרטיס חי! הוא צפצף גם אחרי שעה במים. מדהים ממש.' },
]
...
function ReviewCarousel({ reviews }: { reviews: typeof REVIEWS }) {
  ...
  function handleTouchEnd(e: React.TouchEvent) {
    ...
    if (Math.abs(diff) > 35) setIdx(i => diff > 0 ? (i + 1) % 3 : (i - 1 + 3) % 3)
  }
...
export default function ProductClient({ productId, slug, nameHe, gallery, tiers, inStock }: ProductData) {
  ...
  function addCartItem() {
    addItem({ productId, slug, nameHe: `${nameHe} — ${tier.label}`, image: gallery[0] ?? '', sellingPrice: tier.price, quantity: 1, variantLabel: tier.label })
  }
  function handleAdd() {
    addCartItem()
    setAdded(true)
    setTimeout(() => setAdded(false), 2000)
    track('add_to_cart', { product: slug, tier: tier.label, price: tier.price })
  }
        ...
        {tiers.map((t, i) => {
          ...
          return (
            <button key={i} onClick={() => setTierIndex(i)}
              ...
              {t.badge && (
                <span className={`absolute -top-2.5 right-3 text-white text-xs font-bold px-2.5 py-0.5 rounded-full ${t.badgeColor}`}>{t.badge}</span>
              )}
      ...
      <main className="flex-1 pb-24 lg:pb-0">
        ...
        <div className="lg:hidden">
          <div className="relative bg-[#0C1020] select-none" onTouchStart={e => imgSwipe(e, 'start')} onTouchEnd={e => imgSwipe(e, 'end')}>
            <img src={gallery[activeImg]} alt={nameHe} className="w-full aspect-square object-cover" />
            ...
            <div className="grid grid-cols-2 gap-12 items-start">
              <div className="sticky top-24 space-y-4">
                <div className="relative bg-[#0C1020] rounded-3xl overflow-hidden select-none aspect-square">
                  <img src={gallery[activeImg]} alt={nameHe} className="w-full h-full object-cover" />
                ...
                <div className="grid grid-cols-3 gap-3 text-center">
                  {[{ icon: '🛡️', text: 'אחריות\nלכל החיים' }, { icon: '🚚', text: 'משלוח חינם\nלכל הארץ' }, { icon: '🔒', text: 'תשלום\nמאובטח SSL' }].map(({ icon, text }) => (
          ...
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8">
              ...
              <div className="flex flex-col gap-1.5 max-w-xs mx-auto text-xs">
                {[{ stars: 5, pct: 89, label: '5 כוכבים' }, { stars: 4, pct: 8, label: '4 כוכבים' }, { stars: 3, pct: 3, label: '3 כוכבים' }].map(r => (
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
              {visibleReviews.map(({ photo, name, location, text, detail, stars }) => (
                <div key={name + location} className="bg-white border border-gray-100 rounded-2xl p-4 shadow-sm hover:shadow-md transition-shadow">
                  ...
                  <div className="text-yellow-400 text-sm mb-2">{'★'.repeat(stars)}{'☆'.repeat(5 - stars)}</div>
