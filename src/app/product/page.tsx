...
import type { ProductBundle, ProductPageContent, ReviewItem } from './ProductClient'
...
const FALLBACK_REVIEWS: ReviewItem[] = [
  { photo: 'https://i.pravatar.cc/80?img=9', name: 'דנה כ.', location: 'תל אביב', stars: 5, detail: 'לקוחה 4 חודשים', rating: 5, text: 'שנתיים ממש הייתי מאבדת ארנק כל שבוע, פעמיים שלוש פעמים. מאז שהכנסתי את FindCard? לא חיפשתי פעם אחת. ממש ממליצה 🙏' },
