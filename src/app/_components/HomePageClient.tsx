...
const REVIEWS = [
  {
    initials: 'ד', color: 'bg-blue-500', name: 'דבורה פ.', location: 'תל אביב',
  ...
  {
    initials: 'א', color: 'bg-green-500', name: 'ארז ג.', location: 'חיפה',
  ...
  {
    initials: 'ס', color: 'bg-purple-500', name: 'סמדר א.', location: 'ירושלים',
  ...
  {
    initials: 'ט', color: 'bg-orange-500', name: 'טוביה ל.', location: 'גבעתיים',
    stars: 3, detail: 'לקוח חודשיים',
    text: 'בסדר גמור, עובד כמו שאמרו. הגדרה היתה קצת מבלבלת בהתחלה אבל אחרי 5 דקות הסתדרתי. המשלוח לקח בערך שבועיים שזה קצת הרגיש הרבה. בסה"כ מרוצה.',
  },
  {
    initials: 'מ', color: 'bg-pink-500', name: 'מזל פ.', location: 'נתניה',
  ...
  },
  {
    ...
    text: 'קניתי את החבילה 3+1 ונתתי גם לגרלפרנד. עכשיו שניהם לא מאבדים כלום לגמרי 😂 המשלוח הגיע עם אריזה יפה מאוד. ממליץ בחום.',
  },
  {
    initials: 'נ', color: 'bg-blue-600', name: 'נאוה ק.', location: 'הרצליה',
    stars: 4, detail: 'לקוחה 3 חודשים',
    text: 'קיבלתי במתנה ולא הייתי בטוחה שאשתמש בזה. חודש אחרי — הארנק נפל מהתיק בקניון, Find My הראה שהוא עדין שם!! חזרתי ומצאתי. חסכתי בערך 750 שקל!',
  },
  {
...
export default function HomePageClient({ content = {}, sectionVisibility = {} }: { content?: SectionContent; sectionVisibility?: SectionVisibility }) {
  ...
  return (
    <>
      {/* ── HERO ── */}
      {show('hero') && <section id="hero" className="scroll-mt-28 bg-gradient-to-br from-blue-700 via-blue-600 to-indigo-700 text-white">
      ...
      <section id="guarantee" className="scroll-mt-28 bg-gray-900 text-white py-14 px-4">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <h2 className="text-2xl md:text-3xl font-extrabold mb-3">
            {content.guaranteeHeadline || 'אחריות לכל החיים — 100 יום החזר כסף'}
          </h2>
