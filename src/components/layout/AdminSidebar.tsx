...
const NAV = [
  ...
  },
  {
    ...
    items: [
      ...
      { href: '/admin/integrations',             label: 'אינטגרציות',     Icon: ILink,    sub: 'חיבורים חיצוניים' },
      { href: '/admin/integrations/marketing',   label: 'שיווק ופיקסלים', Icon: IRadio,   sub: 'Meta, TikTok, GA4, GTM' },
